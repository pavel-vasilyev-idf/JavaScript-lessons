...
const appData = {
    ...
    disableInputs: function (disabled = true) {
...
const newStart = appData.start.bind(appData); //- Связь appData с контекстами this
